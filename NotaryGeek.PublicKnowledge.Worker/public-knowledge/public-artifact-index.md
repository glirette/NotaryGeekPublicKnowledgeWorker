...
| Daily public source ingestion contract | Two review-gated authority lanes, strict structured-output validation, provider evidence, idempotent selection, sanitized feeds, retention policy, and destination-owned draft PR promotion | `topics/daily-public-source-ingestion-contract.json` |
