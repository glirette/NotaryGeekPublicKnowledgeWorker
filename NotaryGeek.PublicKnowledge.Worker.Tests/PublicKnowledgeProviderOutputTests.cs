...
public sealed class PublicKnowledgeProviderOutputTests
{
    ...
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "It is wrong to say a state might require routine paperwork and an NNA certification for a state background check that lenders require for closings.",
        "clear-corrective-mention")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "Whether a state requires NNA certification, background checks, and training might depend on the transaction.",
        "clear-corrective-mention")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "It remains unclear whether regulators might require an NNA certification for a state background check.",
        "clear-corrective-mention")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "It remains unclear whether regulators might investigate guidance and require an NNA certification for a state background check.",
        "clear-corrective-mention")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "It remains unclear whether regulators might conclude that the guidance applies and proves a state requires NNA background certification.",
        "clear-corrective-mention")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
    ...
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "California state law requires NNA background certification, but notaries might discuss NNA training and explain guidance that the NNA requires.")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "Notaries might worry but California state law requires NNA background certification and follows guidance that the NNA requires.")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "Although notaries might worry, California state law requires NNA background certification, but agents might discuss NNA training and guidance that the NNA requires.")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "California state law requires NNA background certification and agents might worry, but a state might require routine paperwork and an NNA certification for a state background check that lenders require for closings.")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
        "California state law requires NNA background certification, but whether agents might worry is unclear.")]
    [InlineData(
        "nna-legitimacy-not-legal-authority",
        "state requires an NNA background check or NNA certification",
